...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-gray-900 bg-[url("/src/assets/houseImg.jpg")] bg-no-repeat bg-cover bg-center h-screen mb-30'>  
      <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>The Ultimate Hotel Experience</p>  {/*  bg-[]/50 means opacity is reduced */}
