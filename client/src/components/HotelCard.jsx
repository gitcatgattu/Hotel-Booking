...
const HotelCard = ({room,index}) => {
  return (
    <Link to={`/rooms/${room._id}`} onClick={()=>scrollTo(0,0)} key={room.hotel.id} className={`group relative  max-w-60 w-full rounded-xl bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]  overflow-hidden ${index===0?"col-span-2 md:col-span-3":"col-span-1"} cursor-pointer`}>
