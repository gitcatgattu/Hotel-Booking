...
const FeaturedDestination = () => {
  ...
  return (
    ...
    <Title title="Featured Destinations" subTitle="Discover our handpicked selection of exceptional properties."/>
      ...
      <button onClick={()=>{navigate("/rooms");scrollTo(0,0)}} className='my-5 px-4 py-2 text-sm font-medium border border-gray-300 rounded bg-white hover:bg-gray-50 transition-all cursor-pointer'>View All Destinations</button>
    </div>
  )
}
