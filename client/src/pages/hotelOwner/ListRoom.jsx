  ...
  return (
    <div>
      <Title
        ...
        align={`left`}
        font="outfit"
        subTitle="View,edit, or manage all listed rooms.Keep the information uptodate to provide the best experience for users."
      />
      <p className="text-gray-500 mt-8">All Rooms</p>

      <div
        className="w-full max-w-3x1 text-left border border-gray-300 rounded-1g
